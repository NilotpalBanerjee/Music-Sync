...
const TotalVerifiedPayments = () => {
    ...
    const data = [
        {
            ...
            paymentMode: "OFFLINE",
            verificationDate: "04-02-2026 07:55 PM",
        },
        {
            key: "2",
            slno: 2,
            ...
            paymentMode: "OFFLINE",
            verificationDate: "11-02-2026 07:38 PM",
        },
    ];
    ...
    const columns = [
        ...
        },
        {
            ...
            render: (date) => (
                <Tag className="!bg-green-600 !text-white !px-2 !py-0 !rounded">
                    {date}
                </Tag>
            ),
        },
    ...
    return (
        <div className="p-4">
            <Breadcrumb
                heading="Total Verified Payments"
                title="Total Verified Payments"
            />
...
export default TotalVerifiedPayments;